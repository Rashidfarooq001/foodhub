...
const regex =
  /const elocUrl = \`https:\/\/explore\.mappls\.com\/api\/places\/eloc\?eloc=\\$\{firstResult\.eLoc\}&access_token=\\$\{token\}\`;[\s\S]*?const elocResponse = await fetch\(elocUrl, \{ signal: elocController\.signal \}\);/;
...
console.log('Modified headers for eloc');
