...
content = content.replace(
  /async getFinanceOverview\([\s\S]*?async getUnifiedTransactions/m,
...
content = content.replace(
  /this\.prisma\.settlement\.find/g,
  'this.prisma.restaurantSettlement.find',
);
content = content.replace(
  /this\.prisma\.settlement\.update/g,
  'this.prisma.restaurantSettlement.update',
);
content = content.replace(
  /this\.prisma\.settlement\.create/g,
  'this.prisma.restaurantSettlement.create',
);
content = content.replace(
  /this\.prisma\.settlement\.upsert/g,
  'this.prisma.restaurantSettlement.upsert',
);
