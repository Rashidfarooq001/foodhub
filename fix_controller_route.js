const fs = require('fs');
let code = fs.readFileSync('apps/backend/src/modules/geolocation/geolocation.controller.ts', 'utf8');

code = code.replace(/@Controller\(\['geolocation', 'geo'\]\)/g, `@Controller(['geolocation', 'geo', 'location'])`);
