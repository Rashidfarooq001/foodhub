...
# 2. Update fetchCurrent to fetchActiveJobs
...
# 3. Update toggleDuty disable logic
content = content.replace(
...
# 4. Update rendering of active deliveries
old_render = '''        {/* ACTIVE DELIVERY IN PROGRESS BANNER (If job active) */}
        {currentDelivery && (
