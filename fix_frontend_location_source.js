...
code2 = code2.replace(/locationSource\?: 'CURRENT_GPS' \| 'PLACE_SEARCH' \| 'SAVED_ADDRESS' \| 'MANUAL_ADDRESS';/g, "locationSource?: 'CURRENT_GPS' | 'PLACE_SEARCH' | 'SAVED_ADDRESS' | 'MANUAL_ADDRESS' | 'MANUAL_GEOCODED';");
