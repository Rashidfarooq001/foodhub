            ...
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
              ...
              <div>
                ...
                <div className="flex gap-2">
                  ...
                  {!isPhoneVerified && (
                    <button type="button" onClick={handleVerifyPhoneWithWidget} disabled={isVerifyingPhone || form.phone.length < 10} className="shrink-0 rounded-2xl bg-orange-100 px-4 py-2 text-xs font-bold text-orange-700 hover:bg-orange-200 transition disabled:opacity-50">
                      {isVerifyingPhone ? "Sending..." : "Verify"}
                    </button>
                  )}
                  {isPhoneVerified && (
                    <div className="shrink-0 flex items-center justify-center rounded-2xl bg-emerald-50 px-4 py-2 text-xs font-bold text-emerald-700">
