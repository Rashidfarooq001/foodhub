...
content = content.replace(/const dMarker = new window\.mappls\.Marker\(\{\s+map,\s+position: \{ lat: driverLat, lng: driverLng \},\s+popupHtml: `.*?`,\s+\}\);/g, 
...
content = content.replace(/const dMarker = new window\.mappls\.Marker\(\{\s+map: mapInstanceRef\.current,\s+position: \{ lat: driverLat, lng: driverLng \},\s+popupHtml: `.*?`,\s+\}\);/g,
`const dMarker = new window.mappls.Marker({
...
content = content.replace('// Handle container resize', globalEventListenerCode + '\n  // Handle container resize');
