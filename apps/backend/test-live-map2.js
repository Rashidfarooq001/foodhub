    ...
    const formatted = rawList.map((o) => {
      ...
      return {
        ...
        placedAt: o.createdAt
          ...
          : '',
        customerName: o.customer && o.customer.profile
          ? ((o.customer.profile.firstName || '') + ' ' + (o.customer.profile.lastName || '')).trim()
          : o.customerName || 'Customer',
        customerPhone: (o.customer && o.customer.user && o.customer.user.phone) || o.customerPhone || '',
        customerAddress: addrStr,
        deliveryAddress: o.deliveryAddress,
        deliveryInstructions: o.deliveryInstructions,
        distanceKm: (o.deliveryJob && o.deliveryJob.distanceKm) || o.distanceKm || undefined,
        driverName: (driverObj && driverObj.user && driverObj.user.profile)
          ? ((driverObj.user.profile.firstName || '') + ' ' + (driverObj.user.profile.lastName || '')).trim()
          : undefined,
        driverPhone: (driverObj && driverObj.user && driverObj.user.phone) || undefined,
