      ...
      <div className="mx-auto max-w-7xl px-4 py-5 sm:px-4 lg:px-5">
        <div className="grid grid-cols-1 gap-5 md:grid-cols-4">
          <div className="space-y-3">
            ...
            <p className="text-xs text-gray-400 leading-relaxed">
              Empowering local restaurants and gig delivery couriers with hyper-fast dispatch,
              zero-hassle settlements, and real-time operations tools.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-xs">
              <li>
                <Link href="/restaurant/register" className="hover:text-orange-400">
                  Restaurant Registration
                </Link>
              </li>
              <li>
                <Link href="/driver/register" className="hover:text-orange-400">
                  Courier Fleet Registration
                </Link>
              </li>
              <li>
                <a
          ...
          <div>
            ...
            <ul className="space-y-2 text-xs text-gray-400">
              <li className="flex items-center gap-1.5">
                <ShieldCheck className="h-4 w-4 text-emerald-500" /> FSSAI License Mandatory
              </li>
              <li className="flex items-center gap-1.5">
                <ShieldCheck className="h-4 w-4 text-emerald-500" /> GST Registration Supported
              </li>
              <li className="flex items-center gap-1.5">
                <ShieldCheck className="h-4 w-4 text-emerald-500" /> Valid DL &amp; RC Verification
              </li>
              <li className="flex items-center gap-1.5">
                <Building2 className="h-4 w-4 text-orange-500" /> Direct Bank Payouts
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <div className="space-y-2 text-xs text-gray-300">
              <p className="flex items-center gap-2">
                <Mail className="h-4 w-4 text-orange-500" /> businesscity05@gmail.com
              </p>
        ...
        <div className="mt-8 border-t border-gray-800 pt-6 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-gray-500">
          <div className="flex flex-wrap items-center justify-center gap-4">
            ...
            <span>•</span>
            <Link href="/grievance-redressal" className="hover:text-orange-400">
              Grievance Redressal
            </Link>
          </div>
          <div>© {new Date().getFullYear()} Zayka Food. All Partner Rights Reserved.</div>
        </div>
      </div>
    </footer>
  );
