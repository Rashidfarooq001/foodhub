...
export const Footer: React.FC = () => {
  ...
  return (
    <footer
      className={`bg-gray-900 text-gray-400 w-full ${isHome ? 'hidden md:block' : ''} ${hasStickyBottomBar ? 'pb-24 sm:pb-20' : 'pb-[env(safe-area-inset-bottom)]'}`}
    >
      <div className="mx-auto max-w-7xl px-4 py-3 sm:px-5">
        ...
        <div className="md:hidden flex flex-col space-y-2">
          ...
          <div className="flex flex-wrap items-center justify-center gap-x-2.5 gap-y-1.5 text-[10px] text-gray-500 text-center leading-tight pt-1">
            ...
            <span className="text-gray-700">|</span>
            <Link href="/delivery-policy" className="hover:text-orange-400">
              Delivery
            </Link>{' '}
            <span className="text-gray-700">|</span>
            <Link href="/cookie-policy" className="hover:text-orange-400">
              Cookie
            </Link>{' '}
            <span className="text-gray-700">|</span>
        ...
        <div className="hidden md:flex flex-col space-y-3">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-6 text-xs font-medium">
              ...
              <Link href="/partner" className="hover:text-orange-400 transition font-bold">
                Become a Partner
              </Link>
              <Link href="/support" className="hover:text-white transition">
                Help & Support
          ...
          <div className="flex items-center justify-between border-t border-gray-800/80 pt-3">
            <div className="flex items-center gap-3 text-[11px] text-gray-500">
              ...
              <span className="text-gray-700">•</span>
              <Link href="/grievance-redressal" className="hover:text-orange-400 font-medium">
                Grievance Redressal
              </Link>
            </div>
