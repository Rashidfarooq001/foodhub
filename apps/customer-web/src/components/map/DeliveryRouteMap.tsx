...
export default function DeliveryRouteMap({
  ...
  return (
    <div className="relative h-[300px] w-full overflow-hidden rounded-2xl border border-gray-100 shadow-inner bg-gray-900">
      <Script
      ...
      {mapState === 'ERROR' && (
        <div className="absolute inset-0 z-10 flex flex-col items-center justify-center gap-2 bg-gray-900 p-4 text-center text-white">
