        ...
        <div className="w-full max-w-md text-center space-y-4 rounded-2xl border border-gray-100 bg-white p-5 shadow-2xl">
          ...
          <div className="space-y-2">
            ...
            <p className="text-xs text-gray-500 leading-relaxed max-w-xs mx-auto">
              Restaurant onboarding registration screens are temporarily hidden during active
              development.
            </p>
          </div>
          <div className="pt-2">
      ...
      <div className="mx-auto max-w-3xl px-4 py-10 text-center space-y-4">
        ...
        <div className="rounded-2xl border border-emerald-200 bg-emerald-50/50 p-4 text-sm text-emerald-900 space-y-2">
          ...
          <p className="text-xs text-emerald-700">
            Thank you for applying to partner with ZaykaFood. Our operations team will verify your
            FSSAI license and bank details. Once approved, you can log in to your Merchant
            Dashboard.
          </p>
        </div>
        <Link
  ...
  return (
    <div className="mx-auto max-w-4xl px-4 py-5 sm:px-4 lg:px-5 space-y-5">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className="rounded-2xl border border-gray-100 bg-white p-4 shadow-sm space-y-4">
          <div className="flex items-center gap-2 text-base font-bold text-gray-900 border-b border-gray-100 pb-3">
            <FileText className="h-5 w-5 text-orange-600" /> 2. Licenses &amp; Compliance
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
            ...
            <div>
              ...
              <input
                ...
                value={form.latitude ?? ''}
                onChange={(e) =>
                  setForm((prev) => ({ ...prev, latitude: parseFloat(e.target.value) || null }))
                }
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  setForm((prev) => ({ ...prev, longitude: parseFloat(e.target.value) || null }))
                }
        ...
        <div className="rounded-2xl border border-gray-100 bg-white p-4 shadow-sm space-y-4">
          <div className="flex items-center gap-2 text-base font-bold text-gray-900 border-b border-gray-100 pb-3">
            <ImageIcon className="h-5 w-5 text-orange-600" /> 4. Store Brand Assets &amp;
            Promotional Video
          </div>
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
            <MediaUploader
        ...
        <div className="rounded-2xl bg-gray-50 border border-gray-200 p-4 text-xs text-gray-600 space-y-2">
          <p className="font-bold text-gray-900">
            Merchant Onboarding Acknowledgment &amp; FSSAI Declaration:
          </p>
          <p className="text-[11px] leading-relaxed">
            By submitting this application, you declare that your food business holds a valid FSSAI
            license/registration, agree to adhere to all food safety and hygiene standards, agree to
            the{' '}
            <Link
