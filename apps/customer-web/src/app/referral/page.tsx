      ...
      <div className="mx-auto max-w-lg space-y-4">
        ...
        <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-purple-600 to-pink-500 p-4 text-white shadow-2xl">
          ...
          <p className="mt-1 text-sm text-purple-100">
            Invite friends to ZaykaFood. You earn <strong>₹50</strong>, they get{' '}
            <strong>₹30</strong>.
          </p>
        ...
        <div className="rounded-2xl bg-white border border-gray-100 shadow-sm p-5 space-y-3">
          ...
          <p className="text-xs text-gray-500">
            Enter a referral code to claim your ₹30 welcome bonus.
          </p>
          ...
          {applyMsg && <p className="text-xs font-medium text-gray-700">{applyMsg}</p>}
        </div>
      </div>
    </div>
  );
