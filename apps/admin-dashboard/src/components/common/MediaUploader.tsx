          ...
          <div className="flex items-center gap-3 overflow-hidden">
            ...
            <div className="truncate text-xs">
              ...
              <a
                ...
                className="text-[10px] font-bold text-purple-600 hover:underline flex items-center gap-1 mt-1"
              >
        ...
        <div
          ...
          className={`group flex cursor-pointer flex-col items-center justify-center rounded-2xl border-2 border-dashed p-6 text-center transition ${
            isDragging
              ...
              : 'border-gray-200 bg-gray-50/50 hover:border-purple-400 hover:bg-white'
          }`}
        >
          {isUploading ? (
            <div className="py-4 space-y-2 text-purple-600">
              <Loader2 className="mx-auto h-8 w-8 animate-spin" />
              <span className="block text-xs font-bold">Uploading media to server...</span>
            </div>
          ) : (
            <>
              <div className="mb-2 flex h-10 w-10 items-center justify-center rounded-xl bg-purple-100 text-purple-600 group-hover:scale-110 transition">
