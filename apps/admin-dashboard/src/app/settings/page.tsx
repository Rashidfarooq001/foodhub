                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setForm({
                        ...form,
                        foodGstRate: e.target.value === '' ? '' : Number(e.target.value),
                      })
                    }
                    className="w-full rounded-xl border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800 px-4 py-3 text-sm font-bold text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-orange-500"
                  />
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setForm({
                        ...form,
                        riderBasePay: e.target.value === '' ? '' : Number(e.target.value),
                      })
                    }
                    className="w-full rounded-xl border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800 px-4 py-3 text-sm font-bold text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-orange-500"
                  />
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setForm({
                        ...form,
                        riderPerKmPay: e.target.value === '' ? '' : Number(e.target.value),
                      })
                    }
                    className="w-full rounded-xl border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800 px-4 py-3 text-sm font-bold text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-orange-500"
                  />
              ...
              {simResults ? (
                <div className="rounded-xl bg-white dark:bg-gray-800 border border-purple-100 dark:border-purple-900/30 p-4 text-xs space-y-2">
                  <div className="flex justify-between">
                    ...
                    <span className="font-bold">,1{simResults.foodSubtotal}</span>
                  </div>
                  <div className="flex justify-between">
                    <span>Delivery Fee:</span>{' '}
                    <span className="font-bold">,1{simResults.customerDeliveryFee}</span>
                  </div>
                  <div className="flex justify-between">
                    <span>Platform Fee:</span>{' '}
                    <span className="font-bold">,1{simResults.platformFee}</span>
                  </div>
                  <div className="flex justify-between">
                    <span>GST:</span>{' '}
                    <span className="font-bold">,1{simResults.totalCustomerTaxes}</span>
                  </div>
                  <div className="flex justify-between">
                    <span>Tip (Simulated):</span> <span className="font-bold">,120</span>
                  </div>
                  ...
                  <div className="flex justify-between mt-4 pt-4 border-t border-gray-100 dark:border-gray-700">
                    ...
                    <span className="font-bold text-red-500">
                      -,1{simResults.restaurantCommission}
                    </span>
                  </div>
                  <div className="flex justify-between">
                    <span>Merchant Net Settlement:</span>{' '}
                    <span className="font-bold text-blue-600">
                      ,1{simResults.restaurantSettlement}
                    </span>
                  </div>

                  <div className="flex justify-between mt-2 pt-2 border-t border-gray-100 dark:border-gray-700">
                    <span>Courier Partner Payout:</span>{' '}
                    <span className="font-bold">,1{simResults.totalRiderPayout}</span>
                  </div>
                  <div className="flex justify-between mt-2 pt-2 border-t border-gray-100 dark:border-gray-700 text-sm font-black text-purple-600 dark:text-purple-400">
                    ...
                    <span>,1{simResults.platformContributionMargin}</span>
                  </div>
                </div>
              ) : (
                <div className="text-center text-xs text-gray-500 py-4">
                  Calculating simulator results...
                </div>
              )}
            </div>
          </div>
