...
const regex = /if \(isNaN\(finalLat\) \|\| isNaN\(finalLng\)\) \{[\s\S]*?return this\._fallbackGeocodeFailure\('Mappls returned invalid coordinates\. ' \+ \(firstResult\.eLoc \? 'Failed to resolve eLoc\.' : ''\)\);[\s\S]*?\}/;
