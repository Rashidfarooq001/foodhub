      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 items-start">
        ...
        <div className="space-y-4">
          <div className="rounded-2xl border border-gray-100 bg-white p-5 shadow-sm space-y-4">
            <h3 className="text-sm font-black text-gray-900 uppercase tracking-widest text-orange-600">Contact Us</h3>
            ...
            <div className="space-y-3">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-[11px] text-gray-500 mb-2">Our team usually responds within 2-4 hours.</p>
                  <a href="mailto:businesscity05@gmail.com" className="inline-flex items-center gap-1.5 rounded-xl bg-gray-900 px-4 py-2 text-xs font-bold text-white hover:bg-gray-800 transition">
        ...
        <div className="rounded-2xl border border-gray-100 bg-white p-5 shadow-sm space-y-3">
          <h3 className="text-sm font-black text-gray-900 uppercase tracking-widest text-orange-600 mb-4">Quick Links</h3>
