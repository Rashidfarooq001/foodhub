...
content = content.replace(/import { PrismaService } from "@foodhub\/utils";/g, 'import { PrismaService } from "../../core/prisma/prisma.service";');

// Add missing methods
content = content.replace(/async getUnifiedTransactions\(\) \{ return \[\]; \}/g, `async getUnifiedTransactions() { return []; }
